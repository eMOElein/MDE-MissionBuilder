...
MDM_LuaLoader._luas = {
  ...
  "Hud/MDM_Blip",
  "Core/MDM_Feature",
  "Features/MDM_CallbackFeature",
  "Features/MDM_PlayerInCarBannerFeature",
  "Features/Gameplay/MDM_PoliceFreeZoneFeature",
  "Features/Ai/MDM_AI_NPC_BasicPatrol",
  "Features/Ai/MDM_NPCGoToFeature",
  "Features/Ai/MDM_AI_BasicDetection",
